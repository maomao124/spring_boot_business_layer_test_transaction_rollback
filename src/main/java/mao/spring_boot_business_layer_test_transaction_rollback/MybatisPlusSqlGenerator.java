package mao.spring_boot_business_layer_test_transaction_rollback;
 ...
 * Package(包名): mao.spring_boot_business_layer_test_transaction_rollback
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        */
        ...
        FastAutoGenerator.create(properties.getProperty("jdbc.url"),
                ...
                {
                    builder.parent("mao.spring_boot_business_layer_test_transaction_rollback") // 设置父包名
